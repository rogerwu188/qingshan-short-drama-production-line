#!/usr/bin/env python3
"""Fill and submit an E08 start_frame review from the keyframe findings (claude-code-nalu-vlm).
...
req = sorted(glob.glob(f"{_np.RUNTIME_ROOT}/runtime/reviews/E08/E08-start_frame-*_request.json"))[-1]
