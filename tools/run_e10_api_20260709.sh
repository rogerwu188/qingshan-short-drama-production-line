...
out_dir="${E10_API_OUT_DIR:-working_assets/e10_api_20260709}"

python3 tools/build_e10_api_plan_20260709.py --out-dir "$out_dir"

python3 tools/asset_binding_validator.py \
  --config configs/e10_continuity_config_20shots_director_coverage_20260709.json \
  --manifest configs/e10_asset_binding_manifest_20shots_director_coverage_20260709.json \
  --out qa/e10_preflight_20260709/asset_binding_report.json
