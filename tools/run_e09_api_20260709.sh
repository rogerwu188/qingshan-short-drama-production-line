...
out_dir="${E09_API_OUT_DIR:-working_assets/e09_api_20260709}"

python3 tools/build_e09_api_plan_20260709.py --out-dir "$out_dir"

python3 tools/asset_binding_validator.py \
  --config configs/e09_continuity_config_v2_20shots_fast_20260709.json \
  --manifest configs/e09_asset_binding_manifest_v2_20shots_fast_20260709.json \
  --out qa/e09_v2_preflight_20260709/asset_binding_report.json
