...
def main() -> int:
    ...
    for unit in grouping["units"]:
        ...
        action_class="_".join(name for name,active in (("IDENTITY_REANCHOR",identity_change),("PROP_REANCHOR",prop_change),
        ...
        units.append({"unit_id":unit["unit_id"],"scene_id":unit["scene_id"],"planned_reference_image_count":len(task_keys),
          ...
          "criteria":{"continuous_motion_from_single_start":False,"identity_or_space_reanchor":identity_change or space_change,
          "prop_ownership_transition":prop_change,"non_interpolable_terminal_state":True},"anchor_roles":roles,"action_design_class":action_class},
