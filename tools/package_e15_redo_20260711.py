...
OUT_DIR = BASE / "exports/e15/final_package_redo_20260711"
QA_DIR = BASE / "qa/e15_final_package_redo_20260711"
SEG_DIR = OUT_DIR / "segments"
SUBTITLE_TEXT_DIR = OUT_DIR / "subtitle_texts_clean_redo_20260711"
...
RAW = OUT_DIR / "qingshan_E15_redo_raw_normalized_20260711.mp4"
TAILED = OUT_DIR / "qingshan_E15_redo_tailed_nalu_20260711.mp4"
FINAL = OUT_DIR / "qingshan_E15_redo_final_subtitled_nalu_20260711.mp4"
SOURCE_MANIFEST = OUT_DIR / "e15_redo_source_manifest_20260711.json"
LOUDNESS_REPORT = QA_DIR / "qingshan_E15_redo_loudness_20260711.txt"
CONTACT = QA_DIR / "qingshan_E15_redo_subtitled_contact_20260711.jpg"
MIDPOINT_CONTACT = QA_DIR / "qingshan_E15_redo_all_shots_midpoint_20260711.jpg"
...
SOURCE_BY_SHOT = {
    ...
    4: "working_assets/e15_redo_20260711/videos/shot_04R/result_01.mp4",
    5: "working_assets/e15_redo_20260711/videos/shot_05R/result_01.mp4",
    6: "working_assets/e15_redo_20260711/videos/shot_06R/result_01.mp4",
    7: "working_assets/e15_api_20260711/videos/shot_07/result_01.mp4",
    8: "working_assets/e15_redo_20260711/videos/shot_08R/result_01.mp4",
    ...
    13: "working_assets/e15_redo_20260711/videos/shot_13R/result_01.mp4",
    14: "working_assets/e15_redo_20260711/videos/shot_14R/result_01.mp4",
    15: "working_assets/e15_redo_20260711/videos/shot_15R/result_01.mp4",
    ...
    18: "working_assets/e15_redo_20260711/videos/shot_18R/result_01.mp4",
    19: "working_assets/e15_api_20260711/videos/shot_19/result_01.mp4",
    20: "working_assets/e15_redo_20260711/videos/shot_20R/result_01.mp4",
}

# Native audio is weak on these non-dialogue/evidence shots; add the clinic rain bed.
AMBIENCE_BED_SHOTS = {3, 7, 10, 11, 16, 17, 18, 20}
REPLACED_SHOTS = {4, 5, 6, 8, 13, 14, 15, 18, 20}
...
def retime_to_target(src: Path, dst: Path, *, target_duration: float) -> float:
    current = duration(src)
    if target_duration < current - 0.04:
        run([
        ...
        return duration(dst)
    if abs(target_duration - current) <= 0.04:
        if src != dst:
            run([
    ...
    run([
        str(FFMPEG), "-hide_banner", "-loglevel", "warning", "-y", "-i", str(src),
        "-vf", f"setpts={factor:.8f}*PTS,fps=30,setsar=1",
...
def main() -> int:
    ...
    for shot in range(1, 21):
        ...
        normalized_duration = retime_to_target(base_dst, dst, target_duration=target_duration)
        shot_durations.append(normalized_duration)
        segments.append(dst)
        manifest.append({
            "shot": f"{shot:02d}",
            "source": "redo_replacement_api" if shot in REPLACED_SHOTS else "original_api_reused",
            "path": str(src),
            "normalized": str(dst),
            ...
            "local_text_mask": False,
            "replacement_reason": {
                4: "period-locked yamen pressure wide; old version had modern/police/signage risk",
                5: "door-brace causality repair; closed panels and physical support path required",
                6: "door-seam pressure causality repair; officials must remain outside",
                8: "low-motion BaiLi evidence handoff repair",
                13: "closed-door pressure repair",
                14: "interior brace impact repair",
                15: "public accusation low-motion/period repair",
                18: "evidence reaction low-motion repair",
                20: "coroner box period/text repair; no English/FORENSIC",
            }.get(shot, ""),
        })
    ...
    SOURCE_MANIFEST.write_text(json.dumps({
        ...
        "raw": str(RAW),
        "tailed": str(TAILED),
        "rule": "Clean bottom subtitles only; no central bold quote layer. Redo package uses regenerated period/text-clean replacement clips; no local English-label mask is allowed.",
        "runtime_rule": "Corrected release target is 02:55-02:59. Replacement clips fix period drift, door causality, English text, and low-motion regression before upload/delete swap.",
        "shots": manifest,
