#!/usr/bin/env python3
"""Compile E45 v5 semantic keyframe tasks without provider submission."""
...
PROD = ROOT / "workflow/claude_writer_agent/production/e45_v5_20260828"
QA = ROOT / "qa/e45_v5_preproduction_20260828"
CONTRACT = ROOT / "workflow/claude_writer_agent/scripts/E45_GENERATION_CONTRACT_v5.json"
CANONICAL = ROOT / "workflow/claude_writer_agent/scripts/E45_NARRATIVE_CANONICAL_v5.md"
GROUPING = PROD / "E45_V5_VIDEO_UNIT_GROUPING_PLAN_V1.json"
ANCHORS = PROD / "E45_V5_VIDEO_UNIT_ANCHOR_PLAN_V1.json"
MAP_PLAN = PROD / "E45_V5_COMPLETE_MAP_SHOT_PLAN_LOCKED_V1.json"
MAP_AUTHORITY = PROD / "E45_V5_EPISODE_GLOBAL_SPACE_MAP_AUTHORITY_LOCKED_V1.json"
IDENTITY_MAP = PROD / "E45_V5_IDENTITY_AUTHORITY_MAP_V1.json"
WARDROBE_BIBLE = PROD / "E45_V5_EPISODE_WARDROBE_BIBLE_V1.json"
OUT = PROD / "E45_V5_GIGGLE_KEYFRAME_MANIFEST_PRECHECK_V1.json"
...
ASSETS = {
    ...
    "姚老头": "assets/reference/e08_api_fallback_20260709/characters/CHAR-yao-taiyi-card-clean-20260709.jpg",
    "火寸条商人": "assets/reference/e25_20260719/E25-FAKE-MESSENGER-IDENTITY-LOCK.png",
    "杂货铺老板": "assets/reference/e16_supporting_cast_20260712/CORONER_B12R3_solo_clean_720x1280.jpg",
    "纤夫密谍": "assets/reference/e08_api_fallback_20260709/characters/CHAR-secret-service-watcher-clean-20260709.jpg",
    "糖铺伙计": "assets/reference/e08_api_fallback_20260709/characters/CHAR-skinny-apprentice-card-clean-20260709.jpg",
}

ID_TO_NAME = {
    "CHAR-E45-CHENJI": "陈迹", "CHAR-E45-BAILI": "白鲤", "CHAR-E45-SHIZI": "世子",
    "CHAR-E45-WUYUN": "乌云", "CHAR-E45-YAO-LAOTOU": "姚老头",
    "CHAR-E45-MATCH-MERCHANT": "火寸条商人", "CHAR-E45-DRY-GOODS-OWNER": "杂货铺老板",
    "CHAR-E45-HAULER-SPY": "纤夫密谍", "CHAR-E45-SUGAR-CLERK": "糖铺伙计",
}

SCENE_REFERENCES = {
    "GSM-E45-TAIPING-CLINIC-DOOR-V1": {
        "entity_id": "SCENE-E45-TAIPING-CLINIC-MATERIAL-V1",
        "path": "assets/reference/e08_api_fallback_20260709/scenes/SCENE-taiping-front-hall-clean-20260709.jpg",
    },
    "GSM-E45-TAIPING-CLINIC-COURTYARD-V1": {
        "entity_id": "SCENE-E45-TAIPING-CLINIC-COURTYARD-MATERIAL-V1",
        "path": "assets/reference/e08_api_fallback_20260709/scenes/SCENE-taiping-rear-courtyard-clean-20260709.jpg",
    },
    "GSM-E45-TAIPING-CLINIC-HALL-V1": {
        "entity_id": "SCENE-E45-TAIPING-CLINIC-HALL-MATERIAL-V1",
        "path": "assets/reference/e08_api_fallback_20260709/scenes/SCENE-taiping-front-hall-clean-20260709.jpg",
    },
    "GSM-E45-DONGSHI-BREAKFAST-STALL-V1": {
        "entity_id": "SCENE-E45-DONGSHI-BREAKFAST-MATERIAL-V1",
        "path": "assets/reference/e08_api_fallback_20260709/scenes/SCENE-luocheng-stone-street-clean-20260709.jpg",
    },
    "GSM-E45-DONGSHI-SUGAR-SHOP-V1": {
        "entity_id": "SCENE-E45-DONGSHI-SUGAR-SHOP-MATERIAL-V1",
        "path": "assets/reference/e08_api_fallback_20260709/scenes/SCENE-luocheng-stone-street-clean-20260709.jpg",
    },
    "GSM-E45-JINGWANG-MANSION-FORECOURT-V1": {
        "entity_id": "SCENE-E45-JINGWANG-FORECOURT-MATERIAL-V1",
        "path": "assets/reference/e08_api_fallback_20260709/scenes/SCENE-taiping-front-hall-clean-20260709.jpg",
    },
}
...
def identity_authorities(wardrobe_bible: dict[str, Any]) -> dict[str, Any]:
    wardrobe_by_name = {row["character"]: row for row in wardrobe_bible["characters"]}
    visible = {}
    for name, value in ASSETS.items():
        path = ROOT / value
        if not path.is_file():
            raise ValueError(f"missing E45 identity asset: {value}")
        visible[name] = {
            "path": value, "sha256": sha(path), "qa_status": "PASS",
            "qa_report": "qa/e45_v5_preproduction_20260828/E45_V5_IDENTITY_ASSET_INPUT_QA_V1.json",
            "origin": "ADMITTED_FUNCTIONAL_SUPPORTING_IDENTITY" if name in {"火寸条商人", "杂货铺老板", "纤夫密谍", "糖铺伙计"} else "ADMITTED_PRIOR_EPISODE_NATIVE",
            "wardrobe_contract": wardrobe_by_name.get(name),
        }
    report = {
        "schema": "qingshan.identity_asset_input_qa.v1", "episode": "E45", "status": "PASS",
        "all_paths_exist": True, "all_sha256_verified": True,
        "new_named_character_unique": {},
        "new_identity_visual_review": {
            "火寸条商人": "PASS_DISTINCT_FUNCTIONAL_MERCHANT_IDENTITY_PERIOD_WARDROBE",
            "杂货铺老板": "PASS_DISTINCT_FUNCTIONAL_SHOPKEEPER_IDENTITY_PERIOD_WARDROBE",
            "纤夫密谍": "PASS_DISTINCT_FUNCTIONAL_SPY_IDENTITY_PERIOD_WARDROBE",
            "糖铺伙计": "PASS_DISTINCT_FUNCTIONAL_CLERK_IDENTITY_PERIOD_WARDROBE",
            "乌云": "PASS_RETURNING_NATIVE_ASSET_PRECEDENCE_NO_NEW_CAT_IDENTITY",
        },
        "visible_identity_count": len(visible),
    }
    write_json(QA / "E45_V5_IDENTITY_ASSET_INPUT_QA_V1.json", report)
    authority = {
        "schema": "qingshan.identity_authority_map.v1", "episode": "E45", "canonical_version": 5,
        "authorization_ref": "ROGER-20260828-START-E45-H3-PRODUCTION", "visible_authorities": visible,
...
def character_binding(character_id: str, authorities: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "wardrobe_contract": asset.get("wardrobe_contract"),
    }
...
def scene_binding(global_space_map_id: str) -> dict[str, Any] | None:
    ...
    path = ROOT / spec["path"]
    if not path.is_file():
        raise ValueError(f"missing E45 scene material reference: {spec['path']}")
    return {
...
def prompt_text(
    ...
    wardrobe_unit = {
        ...
        "ordered_prompt_specs": [{"cast": [
            {"character": name, "face_visibility": "VISIBLE_PER_FRAME_CONTENT"} for name in names
        ]}],
    }
    wardrobe_unit["wardrobe_contract"] = wardrobe_rows_for_cast(wardrobe_unit, wardrobe_bible)
    wardrobe_text = wardrobe_prompt_block(wardrobe_unit)
    adult_female_visual = model_specific_adult_female_visual_block(
        wardrobe_unit, target_video_model="MiniMax-H3"
    )
    return "\n".join([
        f"9:16竖版构图。E45《封口費》正式语义首帧，任务 {task_key}，真人实拍电影质感，1440×2560原生2K图像，按后续768×1366 MiniMax-H3视频安全区构图，北宋末年历史短剧。",
        ...
        f"服装身份硬合同：{wardrobe_text}",
        adult_female_visual or "本镜无可应用的明确成年女性 H3 造型附加项。",
...
def main() -> int:
    ...
    wardrobe_bible = read_json(WARDROBE_BIBLE)
    identity_map = identity_authorities(wardrobe_bible)
    ...
    for anchor_unit in anchors["units"]:
        ...
        for shot_id in anchor_unit["reference_image_task_keys"]:
            ...
            # Props remain authored in the source action and map, but E45 has no
            ...
            prompt_contract = {
                ...
                "failures": [],
                "wardrobe_bible": rel(WARDROBE_BIBLE),
                "wardrobe_bible_sha256": sha(WARDROBE_BIBLE),
            }
            tasks.append({
                **map_task, "task_key": task_key, "episode": "E45", "shot_id": shot_id,
                "space_chain_id": (
                ...
                "authorization_ref": "ROGER-20260828-START-E45-H3-PRODUCTION",
    ...
    if [row["editorial_shot_id"] for row in tasks] != expected:
        raise ValueError("E45 anchor task coverage mismatch")
    manifest = {
        "schema": "qingshan.giggle_image_batch_manifest.v2", "episode": "E45", "canonical_version": "v5",
        "title": "封口費", "authorization_ref": "ROGER-20260828-START-E45-H3-PRODUCTION",
        ...
        "consumer_contract": {
            "video_model": "MiniMax-H3", "video_resolution": "768p", "video_delivery_raster": "768x1366", "video_aspect_ratio": "9:16",
        ...
        "machine_gate_reports": [
            rel(QA / "E45_V5_COMPLETE_MAP_MODE_GATE_V1.json"),
            rel(QA / "E45_V5_VIDEO_UNIT_GROUPING_GATE_V1.json"),
            rel(QA / "E45_V5_IDENTITY_ASSET_INPUT_QA_V1.json"),
            rel(QA / "E45_V5_VIDEO_UNIT_ANCHOR_COUNT_GATE_V1.json"),
        ],
