#!/usr/bin/env python3
"""Pinned V2 invoker for the inode-independent immutable snapshot gate."""
...
VALIDATOR = ROOT / "tools/validate_e40_u12_immutable_snapshot_upgrade_request_v2.py"
VALIDATOR_SHA256 = "dea78677b7e629af582e7a88fb528dee14462a060495a155e8852861856076c3"
POLICY = ROOT / "workflow/claude_writer_agent/production/e40_claude_writer_v3_140d4b7b_20260808/u12_v30_inode_independence_hardening_v2/E40_U12_V30_IMMUTABLE_PRE_UPGRADE_SNAPSHOT_POLICY_V2.json"
POLICY_SHA256 = "f89daf57e71e349ba185081a32d491fe1d2f47f50f134367af4ae0017183159c"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the E40/U12 V2 inode-independent snapshot gate with exact-SHA pins.",
        allow_abbrev=False,
    )
