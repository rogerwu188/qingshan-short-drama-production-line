...
ORIG_RUN_DIR = Path(os.environ.get("E10_RUN_DIR", BASE / "working_assets/e10_api_20260709"))
REPAIR_RUN_DIR = Path(os.environ.get("E10_REPAIR_DIR", BASE / "working_assets/e10_api_repair_20260709"))
OUT_DIR = Path(os.environ.get("E10_OUT_DIR", BASE / "exports/e10/final_package_20260710"))
QA_DIR = Path(os.environ.get("E10_QA_DIR", BASE / "qa/e10_final_package_20260710"))
SEG_DIR = OUT_DIR / "segments"
SUBTITLE_TEXT_DIR = OUT_DIR / "subtitle_texts_clean_20260710"
LOGO = BASE / "libraries/brand/nalu_motion_cat_logo_v1.png"

RAW = OUT_DIR / "qingshan_E10_raw_normalized_20260710.mp4"
TAILED = OUT_DIR / "qingshan_E10_tailed_nalu_20260710.mp4"
FINAL = OUT_DIR / "qingshan_E10_final_subtitled_nalu_20260710.mp4"
CONTACT = QA_DIR / "qingshan_E10_final_subtitled_contact_20260710.jpg"
MIDPOINT_CONTACT = QA_DIR / "qingshan_E10_final_all_shots_midpoint_20260710.jpg"
SOURCE_MANIFEST = OUT_DIR / "e10_final_source_manifest_20260710.json"
LOUDNESS_REPORT = QA_DIR / "qingshan_E10_final_loudness_20260710.txt"
...
def source_for(shot: int) -> tuple[str, Path]:
    if shot in REPAIRS:
        ...
        path = ORIG_RUN_DIR / f"videos/shot_{shot:02d}/result_01.mp4"
        source = "original"
    if not path.exists():
        raise SystemExit(f"Missing E10 source clip: {path}")
    return source, path
...
def make_tail_card(dst: Path) -> None:
    ...
    filter_complex = (
        ...
        "drawtext=fontfile=/System/Library/Fonts/STHeiti\\ Medium.ttc:"
        "text='第11集继续':fontcolor=white:fontsize=38:x=(w-text_w)/2:y=520,"
...
def main() -> int:
    ...
    contact_times = [2, 6, 12, 20, 30, 40, 50, 60, 72, 84, 96, 108, 119, 122]
