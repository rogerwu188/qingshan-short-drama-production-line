...
from tools.wardrobe_identity_contract import SCHEMA as WARDROBE_SCHEMA
...
def main()->int:
    ...
    for unit in grouping["units"]:
        ...
        payload={**unit,"model":"MiniMax-H3","resolution":"768p","aspect_ratio":"9:16","ordered_prompt_specs":ordered,
