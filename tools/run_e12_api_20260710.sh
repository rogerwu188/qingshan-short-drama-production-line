...
out_dir="${E12_API_OUT_DIR:-working_assets/e12_api_20260710}"

python3 tools/build_e12_api_plan_20260710.py --out-dir "$out_dir"

python3 tools/asset_binding_validator.py \
  --config configs/e12_continuity_config_20shots_20260710.json \
  --manifest configs/e12_asset_binding_manifest_20260710.json \
  --out qa/e12_preflight_20260710/asset_binding_report.json
