#!/usr/bin/env python3
"""Build exact-SHA parallel QA inputs for E27 AgentCut v15."""
...
OUT = ROOT / "qa/e27_agentcut_v15_writer_agent_v040_native_text_r2_20260720"
...
def main() -> int:
                ...
                "items": [
                    {
                        ...
                        "importance": "critical",
                        "pass_score": 4.5,
                        "clip_id": "E27-AGENTCUT-V15-WRITER-AGENT-V040-NATIVE-TEXT-R2-FULL-CUT",
                        "metadata": {
                            "episode": "E27",
                            ...
                            "review_focus": [
                                ...
                                "dialogue intelligibility and sentence completeness only where expected_text is non-empty",
                                "no readable or pseudo-readable text, black frames, frozen filler or duplicated cadence",
                                "N08 wrist-tying action and N19 blank tag placement remain exact",
    ...
    receipt = ROOT / "workflow/tasks/E27_AGENTCUT_V15_WRITER_AGENT_V040_QA_PACKAGE_RECEIPT_20260720.json"
    receipt.write_text(
        json.dumps(
            {
                "episode": "E27",
