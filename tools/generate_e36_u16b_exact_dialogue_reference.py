#!/usr/bin/env python3
"""Generate and verify the exact U16B messenger dialogue reference."""
...
OUT = ROOT / "working_assets/e36_dialogue_audio_refs_20260729/u16b"
QA = ROOT / "qa/e36_v2_stills_repair_20260729/u16_video_runtime/E36_U16B_EXACT_DIALOGUE_AUDIO_QA_V1.json"
RECEIPT = ROOT / "workflow/tasks/E36_U16B_EXACT_DIALOGUE_AUDIO_GENERATION_V1.json"
TEXT = "小的不识字，只认得这戳记，留着好有个凭证。"
...
def main() -> int:
    ...
    command = [
        ...
        VOICE_ID,
        "--emotion",
        "洛城普通递信人继续低声解释票根来由，畏缩发紧、气息微颤、口语自然清楚；不可做王府传令腔或现代口播腔",
        "--speed",
        "1.04",
        "--output-dir",
        str(OUT),
