...
- E41 起执行授权 `ROGER-20260818-US-PACING-V2-RESTRUCTURE`：逐集 manifest 必填 `pacing_v2`，并通过注册门 `SCRIPT-US-DRAMA-EVENT-DENSITY`。硬指标为 8–12 场、单场 ≤22 秒、按 `pacing_v2.location_list` 计不同地点 ≥4、同地点连续 ≤2、时间跳跃 ≥1、并行线 ≥2、跨线切换 ≥3、无转折场 =0、新增地点 ≤2、全集对白占比 ≤35%、动作场对白占比 ≤20%。事件只接受非空「行为→外部改变」因果句；连续三集场数相同须提供剧情依据。E40 及更早集次仅回测告警，不追溯阻断。
